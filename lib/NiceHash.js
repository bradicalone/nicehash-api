...
class NiceHash {
    ...
    async getTime() {
        const res = await _requestPromiseNative.default({
   ...
   */
    ...
    async getOrderBook() {
        ...
        try {
          ...
          // console.log( 'RESPONSE ', res.stats.USA.orders)
          // console.log( 'RESPONSE ', res.stats.USA.orders.length)
          return res
        } catch ( err ) {
    ...
    async getPools() {
        ...
        try {
            ...
            console.log('err: catch NiceHash.js line 529', err)
